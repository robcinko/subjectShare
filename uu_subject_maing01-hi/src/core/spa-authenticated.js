...
import SubjectList from "../routes/subjects-list";
import Testing from "../routes/testing";
import SubjectCreate from "../routes/subjects-create";
import StudyProgramCreate from "../routes/study-program-create";
import SubjectDetail from "../routes/subject-detail";
import SubjectUpdate from "../routes/subject-update";
import SubjectStudyMaterials from "../routes/subject-study-materials"
//@@viewOff:imports
...
const ROUTES = {
  ...
  subjectCreate: { component: <SubjectCreate/>},
  studyProgramCreate: { component: <StudyProgramCreate/>},
  subjectDetail: { component: <SubjectDetail/>},
  subjectUpdate: { component: <SubjectUpdate/>},
  subjectStudyMaterials: { component: <SubjectStudyMaterials/>},
