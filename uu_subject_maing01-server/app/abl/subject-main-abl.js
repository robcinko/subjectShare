...
const Errors = require("../api/errors/subject-main-error.js");
...
const logger = LoggerFactory.get("SubjectMainAbl");

class SubjectMainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    // HDS 2
    const schemas = ["subjectMain", "subject", "studyProgram"];
...
module.exports = new SubjectMainAbl();
